      ...
      <header class="header">
        <div class="container">
          <div class="d-flex align-items-center">
            ...
            <p class="header__text m-0">Official distributor of <span class="current-product__name">Bioven </span><span class="country"></span></p>
          </div>
        </div>
      </header>
      <!-- main-->
            ...
            <div class="order__content clearfix">
              <div class="col-md-6 float-md-left pr-md-2">
                <div class="order-info__content order-info__content_light_green mb-sm-3 mb-2">
                  ...
                  <p class="order-info__text m-0"> <span class="current-product__name font-weight-bold">Bioven</span>&nbsp;product specialist will contact you soon to answer your questions and clarify delivery details.</p>
                </div>
              </div>
                  ...
                  <div class="order-product__item current-product">
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="order-product-spec-wrap">
                        <p class="order-id">Your order number is <span class="order-id__value">8772243-ID</span></p>
                        <p class="current-product__text"><span class="current-product__name">Bioven</span></p>
                        <p class="current-product__description m-0">Средство от морщин</p>
                      </div><img class="current-product__img" src="https://static.infothroat.com/offers/db2fefd2-6342-499c-91a8-eae0cf5653a5.png" alt="product">
                    </div>
                  </div>
...
<noscript><img src="https://www.facebook.com/tr?id=<?=$fb_id?>&ev=PageView&noscript=1" width="1" height="1" style="display: none;"></noscript>
<noscript><img src="https://www.facebook.com/tr?id=<?=$fb_id?>&ev=Lead&noscript=1" width="1" height="1" style="display: none;"></noscript>
